# -*- coding: utf-8 -*-
"""schizo_classification.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1m_IslHEobicCIncM8HIHHmUweFS-j3Pb
"""
...
dataset.Negative_Symptom_Score = (dataset.Negative_Symptom_Score >= 70).astype(int)
...
X = dataset.drop(columns=['Patient_ID', 'Age', 'Gender', 'Education_Level', 'Positive_Symptom_Score',	'Negative_Symptom_Score', 'Suicide_Attempt', 'Hospitalization', 'GAF_Score', 'Social_Support','Suicide_Attempt', 'Medication_Adherence'])
...
# Select a subset of points (to avoid too many bars)
indices = np.linspace(0, len(fpr) - 1, num=10, dtype=int)  # Pick 10 evenly spaced points
